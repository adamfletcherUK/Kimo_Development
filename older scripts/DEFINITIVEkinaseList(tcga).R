...
#now need to keep only transcripts that are used by TCGA
tcgatranscripts <- read.csv ( file = 'SOURCE_Correct_TCGA_Transcript2nd.csv')
genbank = merge(tcgatranscripts, genbank, by = 'f', nomatch = 0)
...
merged_G1 <- merged
write.csv (merged_G1, file='outputs/tcga/merged_GxGxxG_G1.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_G2 <- merged
write.csv (merged_G2, file='outputs/tcga/merged_GxGxxG_G2.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_K <- merged
write.csv (merged_K, file='outputs/tcga/critical_lysine.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_DFG_D <- merged
write.csv (merged_DFG_D, file='outputs/tcga/merged_DFG_G.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_DFG_F <- merged
write.csv (merged_DFG_D, file='outputs/tcga/merged_DFG_F.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_DFG_G <- merged
write.csv (merged_DFG_G, file='outputs/tcga/merged_DFG_G.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_HRD_H <- merged
write.csv (merged_HRD_H, file='outputs/tcga/merged_HRD_H.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_HRD_R <- merged
write.csv (merged_HRD_R, file='outputs/tcga/merged_HRD_R.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_HRD_D <- merged
write.csv (merged_HRD_D, file='outputs/tcga/merged_HRD_D.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_APE_A <- merged
write.csv (merged_APE_A, file='outputs/tcga/merged_APE_A.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_APE_P <- merged
write.csv (merged_APE_P, file='outputs/tcga/merged_APE_P.csv')
...
merged <- subset(merged, DUP == 'TRUE')
merged_APE_E <- merged
write.csv (merged_APE_E, file='outputs/tcga/merged_APE_E.csv')
...
write.csv (merged_correctedG, file='outputs/tcga/merged_correctedG.csv')
...
write.csv (total, file ='outputs/tcga/total.csv')

freqscreen <- table(total$Gene)
write.csv (freqscreen, file ='SOURCE_tcgafreqscreen.csv')         
...
write.csv (merged, file ='TEMP_check_tcga-1.csv')
...
write.csv (genefreq, file ='TEMP_stringentscreen_tcga.csv')
...
write.csv (genefreqFLEXIBLE, file ='TEMP_flexscreen_tcga.csv')

freqSTRINGENT <-table(genefreq$Gene)
write.csv (freqSTRINGENT, file ='TEMP_freqSTRINGENT_tcga.csv')


freqFLEX <-table(genefreqFLEXIBLE$Gene)
write.csv (freqFLEX, file ='TEMP_freqFLEXIBLE_tcga.csv')

#to length correct
freq <- read.csv ('SOURCE_freqTRUNCtcga.csv')
...
write.csv (matches, file ='SOURCE_lengthcorrectedfreq_tcga.csv')
