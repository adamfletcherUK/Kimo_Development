##########################
# Script 1: Identifying truncation mutations within the TCGA database that occur before the end of the kinase domain
#
...
# will match ref amino acid as well as codon (endCatalytic)
...
# removes cases with more than one truncation mutation within the same sample (case_id) 
