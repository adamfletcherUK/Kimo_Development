...
write.csv (merged, file ='TEMP_check_tcga-1_all.csv')
...
write.csv (genefreq, file ='TEMP_stringentscreen_tcga_all.csv')


freqSTRINGENT <-table(genefreq$Gene)
write.csv (freqSTRINGENT, file ='TEMP_freqTRUNCtcgaALL.csv')



#to length correct
freq <- read.csv ('TEMP_freqTRUNCtcgaALL.csv')
...
write.csv (matches, file ='TEMP_lengthcorrectedfreq_tcgaALL.csv')