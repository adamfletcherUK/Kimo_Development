...
write.csv (genbankkinases, file ='outputs/CCLEgenbankkinases.csv')
...
write.csv (merged_HRD_Dp5, file='outputs/ccle/merged_HRD_D_all.csv')
...
#Merge transcripts script is in TCGA script
