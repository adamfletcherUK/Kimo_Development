...
# merge with 411 kinase gene names with motif data
names   <- read.csv (file = 'SOURCE_411kinases_genename.csv') 
genbankkinases = merge(genbank, names, by = 'Gene', nomatch = 0)

#check how many unique kinases
uniqkinase <- genbankkinases$Gene
unique(uniqkinase)
# this displays 411 unique kinase names in TCGA
...
write.csv (freqscreen, file ='SOURCE_tcgafreqscreen_ALLTRANSCRIPTS_Original.csv')         
